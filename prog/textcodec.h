...
public:
    ...
    static constexpr int BOM = 0xFEFF;
    static constexpr int NONE = 0;
    static constexpr int BASE64 = 1;
    static constexpr int HEX = 2;
    static constexpr int UTF8 = 65001;
    static constexpr int UTF16LE = 1200;
    static constexpr int UTF16BE = 1201;
    static constexpr int UTF32LE = 12000;
    static constexpr int UTF32BE = 12001;
    void Reset();
    void AddBOM();
    void RemoveBOM();
