...
CoreStatic::CoreStatic()
{

}

int CoreStatic::FontCounter(int CurrentValue)
{
    if (CurrentValue == 0)
    {
        return 0;
...
int CoreStatic::FontSizeCode(int S, int N)
{
    switch (S)
    {
        default: return 0;
...
bool CoreStatic::GetAttribBit(int Attrib, int Bit)
{
    switch (Bit)
    {
        case 0:
...
int CoreStatic::SetAttribBit(int Attrib, int Bit, bool Val)
{
    switch (Bit)
    {
        case 0:
...
std::string CoreStatic::GetAttribText(int Attrib)
{
    //Bold
    // Italic
    //  Underline
