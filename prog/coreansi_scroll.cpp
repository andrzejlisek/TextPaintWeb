...
void CoreAnsi::AnsiScrollSetOffset(int Offset)
{
    ...
    if (AnsiScreenWork)
    {
        if (Offset < 0)
        {
            ScreenSetLineOffset(AnsiState_.__AnsiScrollLast, Offset, false, AnsiState_.__AnsiBack, AnsiState_.__AnsiFore, AnsiState_.__AnsiAttr);
            for (int Y = AnsiState_.__AnsiScrollLast - 1; Y > AnsiState_.__AnsiScrollFirst; Y--)
            {
                ScreenSetLineOffset(Y, Offset, false, AnsiState_.__AnsiBack, AnsiState_.__AnsiFore, AnsiState_.__AnsiAttr);
            }
            ScreenSetLineOffset(AnsiState_.__AnsiScrollFirst, Offset, true, AnsiState_.__AnsiBack, AnsiState_.__AnsiFore, AnsiState_.__AnsiAttr);
        }
        else
        {
            ScreenSetLineOffset(AnsiState_.__AnsiScrollFirst, Offset, false, AnsiState_.__AnsiBack, AnsiState_.__AnsiFore, AnsiState_.__AnsiAttr);
            for (int Y = AnsiState_.__AnsiScrollFirst + 1; Y < AnsiState_.__AnsiScrollLast; Y++)
            {
                ScreenSetLineOffset(Y, Offset, false, AnsiState_.__AnsiBack, AnsiState_.__AnsiFore, AnsiState_.__AnsiAttr);
            }
            ScreenSetLineOffset(AnsiState_.__AnsiScrollLast, Offset, true, AnsiState_.__AnsiBack, AnsiState_.__AnsiFore, AnsiState_.__AnsiAttr);
        }
    }
}
...
void CoreAnsi::AnsiScrollLines(int Lines)
{
    while (Lines < 0)
    {
        ...
        {
            ScreenMove(ScrollMarginL, AnsiState_.__AnsiScrollFirst, ScrollMarginL, AnsiState_.__AnsiScrollFirst + 1, ScrollMarginR - ScrollMarginL, AnsiState_.__AnsiScrollLast - AnsiState_.__AnsiScrollFirst);
        }
    ...
    while (Lines > 0)
    {
        ...
        if (AnsiScreenWork && (AnsiState_.__AnsiScrollLast > AnsiState_.__AnsiScrollFirst))
        {
            ScreenMove(ScrollMarginL, AnsiState_.__AnsiScrollFirst + 1, ScrollMarginL, AnsiState_.__AnsiScrollFirst, ScrollMarginR - ScrollMarginL, AnsiState_.__AnsiScrollLast - AnsiState_.__AnsiScrollFirst);
        }
