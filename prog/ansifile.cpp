...
Str AnsiFile::Process(AnsiLineOccupyEx TextBuffer, int TextBufferI, int AnsiMaxX)
{
    Str TextFileLine;
    ...
    for (int ii = 0; ii < TextBuffer.CountItems(TextBufferI); ii++)
    {
        ...
        if (TextBuffer.Item_Char < Screen::UnicodeCount)
        {
            ...
            {
                TextFileLine.Add(27);
                TextFileLine.AddRange(Str::FromString("[0;"));
                TextFileLine.AddRange(Str::FromString(TextBuffer.Item_FontW));
                TextFileLine.Add(';');
                TextFileLine.AddRange(Str::FromString(TextBuffer.Item_FontH));
                TextFileLine.Add('V');
