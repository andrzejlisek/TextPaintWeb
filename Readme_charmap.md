...
Note: Designation G0 as any Type\-2 character set is not possible\. Character set designation not works when **ANSIDOS=1**\.
...
| 1 | H | Swedish | Depends on NRC | US ASCII | VT200 |
